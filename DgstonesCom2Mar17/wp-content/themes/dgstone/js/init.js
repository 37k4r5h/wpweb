	...
	$(function() {
		...
		// Scrolly.
			$window.load(function() {
				...
				var x = parseInt($('section').first().css('padding-top')) + 65;
				$('.main-navigation li a, .scrolly').scrolly(1000, x);
...
$('#menu-main-menu li a').click(function(){
 $('#menu-main-menu li').removeClass('current-menu-item current_page_item' );
$(this).closest('li').addClass('active current-menu-item current_page_item'); 
